...
<p className='body-2 mb-8 text-n-4 md:mb-16 mt-4 lg:mb-32 lg:w-[22rem] lg:mx-auto'>
{collabText}
</p>
...
<div className={`relative -top-[1.6rem] 
  flex w-[3.2rem] h-[3.2rem] bg-n-7 border border-n-1/50 rounded-xl -rotate-${index*45}`}>
  <img src={app.icon}
  className='m-auto' width={app.width}
